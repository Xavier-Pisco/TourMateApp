...
public:
     ...
     * @return the vertex
     */
    static Vertex<VertexInfoXML, WayInfoXML> * getVertex(MapContainer * graphContainer, bool mandatory = true);
     ...
     * @return the vertex
     */
    static Vertex<VertexInfoXML, WayInfoXML> * getVertexWithGPSCoords(MapContainer * mapContainer);
     ...
     * @return the vertex
     */
    static Vertex<VertexInfoXML, WayInfoXML> * getVertexWithLocationName(MapContainer * graphContainer);
